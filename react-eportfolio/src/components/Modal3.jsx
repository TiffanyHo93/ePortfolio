...
import lc1 from '../assets/projects/lc1.png'
        ...
        <div className="relative rounded-lg shadow bg-gradient-to-r from-indigo-700 via-purple-800 to-pink-900">
          <div className="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white">
                  LiveConnect - Cross-Platform Application
              </h3>
          ...
          <div className='max-w-[1000px] h-full mx-auto px-8 grid grid-cols-3 gap-4 justify-center items-center'>
            <div className='col-span-2 text-white py-4 max-w-[700px] text-right'>
              <p className='mb-3'>
                LiveConnect is a cross-platform solution that allows you to connect with those that matter to organize social gatherings seamlessly and effortlessly.
              </p>
              <p className='mb-3'>
                Back-end: PostgreSQL, Express, React, Node.JS, ngrok, Google Firebase and Firestore, NGINX
              </p>
              <p>
                Font-end: Ionic Capacitor, Bootstrap, React-Bootstrap
              </p>
            </div>
            <div className="my-auto">
                <img src={lc1} className="w-100 py-5" alt="LearningBeat"/>
            </div>
          </div>
